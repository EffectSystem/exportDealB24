<?php
	 ...
	 *  @version 1.31
	 *  define:
	 *      WEB_HOOK_URL = 'https://rest-api.bitrix24.com/rest/1/doutwqkjxgc3mgc1/'  //url on creat Webhook
	 *      or
	...
	class CRest
	{
		...
		const WEB_HOOK_URL = 'https://b24-vl3cln.bitrix24.ru/rest/1/rs09q5rh2o8xvvpx/';
		...
		private static function getAppSettings()
		{
			if(!empty(static::WEB_HOOK_URL))
			{
				...
				$arData = [
					'client_endpoint' => static::WEB_HOOK_URL,
					'is_web_hook'     => 'Y'
				];
				$isCurrData = true;
			}
